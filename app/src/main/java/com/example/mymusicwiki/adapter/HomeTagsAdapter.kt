...
class HomeTagsAdapter(private val tagList:ArrayList<HomeTag>, private val size:Int, private val onItemClicked:(position:Int)->Unit):RecyclerView.Adapter<HomeTagsAdapter.ViewHolder>() {
